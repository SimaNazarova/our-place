    ...
    787: function (e, t, n) {
      ...
      var i,
        ...
        p = function (e, t, n) {
          ...
          return function () {
            t.value >= 0 &&
              (n || m.has(t) || "hidden" === document.visibilityState) &&
              ((t.delta = t.value - (i || 0)),
            ...
            a = function (e) {
              "first-contentful-paint" === e.name &&
                ...
                e.startTime < i.timeStamp &&
                  ((r.value = e.startTime), r.entries.push(e), m.add(r), n()));
            },
            ...
            s(function (i) {
              (r = u("FCP")),
                ...
                requestAnimationFrame(function () {
                  requestAnimationFrame(function () {
                    (r.value = performance.now() - i.timeStamp), m.add(r), n();
                  });
                });
            }));
        },
        ...
        w = function (e, t) {
          i ||
            ((i = t), (r = e), (a = new Date()), b(removeEventListener), L());
        },
        L = function () {
          if (r >= 0 && r < a - E) {
            var e = {
        ...
        F = function (e, t) {
          ...
          if (o) {
            ...
            var v = function () {
              m.has(r) ||
                (o.takeRecords().map(a), o.disconnect(), m.add(r), n());
            };
...
//# sourceMappingURL=787.d83cbedb.chunk.js.map
